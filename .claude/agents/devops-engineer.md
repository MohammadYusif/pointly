...
description: >
  DevOps and infrastructure agent for the Pointly platform.
  Handles CI/CD pipelines, Terraform operations, CloudWatch
  monitoring, deployment troubleshooting, and AWS resource
  management. Critical for infra changes and deployment issues.
---
