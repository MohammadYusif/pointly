...
description: >
  Security audit agent for the Pointly loyalty platform.
  Reviews auth flows, IAM permissions, input validation,
  secret handling, and data protection. Critical for auth
  changes, new endpoints, and pre-release reviews.
---
