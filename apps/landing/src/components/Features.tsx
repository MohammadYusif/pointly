...
const ICONS = [
  ...
  <svg key="3" width="20" height="20" viewBox="0 0 20 20" fill="none">
    <path d="M4 15h3v-5H4v5zm4.5 0h3v-9h-3v9zM13 15h3V6h-3v9z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
  </svg>,
  // Manual Entry
  ...
  // Redemption
  <svg key="6" width="20" height="20" viewBox="0 0 20 20" fill="none">
    <path d="M3 10a7 7 0 1014 0A7 7 0 003 10z" stroke="currentColor" strokeWidth="1.5" />
    <path d="M10 7v6M8 9l2-2 2 2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>,
];
