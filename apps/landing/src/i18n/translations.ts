      ...
      plans: [
        {
          ...
          features: ['1 store location', '100 SMS / month', 'Pointly network access'],
          cta: 'Get started',
          popular: false,
        },
        {
          ...
          features: ['Up to 3 locations', '500 SMS / month', 'Pointly network access'],
          cta: 'Get started',
          popular: true,
        },
        {
          ...
          features: ['Unlimited locations', '2,000 SMS / month', 'Pointly network access'],
          cta: 'Contact sales',
          popular: false,
        },
      ],
      ...
      plans: [
        {
          ...
          features: ['فرع واحد', '100 رسالة SMS / شهرياً', 'الوصول إلى شبكة بوينتلي'],
          cta: 'ابدأ الآن',
          popular: false,
        },
        {
          ...
          features: ['حتى 3 فروع', '500 رسالة SMS / شهرياً', 'الوصول إلى شبكة بوينتلي'],
          cta: 'ابدأ الآن',
          popular: true,
        },
        {
          ...
          features: ['فروع غير محدودة', '2,000 رسالة SMS / شهرياً', 'الوصول إلى شبكة بوينتلي'],
