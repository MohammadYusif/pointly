...
description: Terraform infrastructure for Pointly including AWS modules, DynamoDB tables, Cognito pools, CloudFront setup, and deployment workflows. Load when working with packages/infrastructure/ or Terraform configuration.
---
