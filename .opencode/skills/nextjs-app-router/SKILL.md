...
description: Next.js 15/16 App Router patterns including server/client components, data fetching, caching, layouts, route groups, and metadata for the Pointly frontends. Load when working with Next.js pages or layouts.
---
