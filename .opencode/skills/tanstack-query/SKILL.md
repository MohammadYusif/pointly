---
name: tanstack-query
description: TanStack Query v5 patterns including query key design, cache invalidation, optimistic updates, mutations, and infinite queries for Pointly frontend data fetching. Load when working with API hooks or cache management.
---
