---
name: code-reviewer
description: Pre-commit code review agent. Checks conventions, security, performance, and Biome compliance before merging. Reads diffs, identifies issues by severity (BLOCKING/WARNING/SUGGESTION), and produces structured review reports.
mode: subagent
color: warning
---
