...
description: Performance analysis agent. Reviews DynamoDB query patterns, Lambda cold starts, bundle sizes, API latency, and frontend rendering performance. Invoked for performance regressions and optimization sprints.
mode: subagent
color: accent
---
